...
// function change(){
       ...
       $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"END2020"}');
        ...
        sleep(15);
        $end2020 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"END2020"}');
        $end2020 = fetch_value($end2020,'"gomart":"','"');
        echo "\n".color("blue","# Message: ".$end2020);
        sleep(3);
        ...
        $expired13 = getStr1('"expiry_date":"','"',$cekvoucher,'13');
         ...
         echo color("Blue","▬▬▬▬▬▬▬▬▬▬▬▬▬▬🔧 PIN GOPAY = 000000 🔧▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"000000"}';
